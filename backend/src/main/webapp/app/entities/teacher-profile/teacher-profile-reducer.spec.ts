...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEACHERPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEACHERPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEACHERPROFILE actions', async () => {
      const arg = { id: 1898 };
    ...
    it('dispatches UPDATE_TEACHERPROFILE actions', async () => {
      const arg = { id: 1898 };
    ...
    it('dispatches PARTIAL_UPDATE_TEACHERPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEACHERPROFILE actions', async () => {
      const arg = 42666;
