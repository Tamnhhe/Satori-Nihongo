...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './flashcard.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLASHCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FLASHCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FLASHCARD actions', async () => {
      const arg = { id: 13755 };
    ...
    it('dispatches UPDATE_FLASHCARD actions', async () => {
      const arg = { id: 13755 };
    ...
    it('dispatches PARTIAL_UPDATE_FLASHCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FLASHCARD actions', async () => {
      const arg = 42666;
