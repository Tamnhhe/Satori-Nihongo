  ...
  return (
    <div>
      <h2 id="quiz-heading" data-cy="QuizHeading">
        <Translate contentKey="onlineSatoriPlatformApp.quiz.home.title">Quizzes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="onlineSatoriPlatformApp.quiz.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/quiz/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="onlineSatoriPlatformApp.quiz.home.createLabel">Create new Quiz</Translate>
          </Link>
        </div>
      </h2>
        ...
        {quizList && quizList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="onlineSatoriPlatformApp.quiz.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('isTest')}>
                  <Translate contentKey="onlineSatoriPlatformApp.quiz.isTest">Is Test</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('isTest')} />
                </th>
                <th className="hand" onClick={sort('isPractice')}>
                  <Translate contentKey="onlineSatoriPlatformApp.quiz.isPractice">Is Practice</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('isPractice')} />
                </th>
                <th className="hand" onClick={sort('quizType')}>
                  <Translate contentKey="onlineSatoriPlatformApp.quiz.quizType">Quiz Type</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('quizType')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {quizList.map((quiz, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{quiz.isTest ? 'true' : 'false'}</td>
                  <td>{quiz.isPractice ? 'true' : 'false'}</td>
                  <td>
                    <Translate contentKey={`onlineSatoriPlatformApp.QuizType.${quiz.quizType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="onlineSatoriPlatformApp.quiz.home.notFound">No Quizzes found</Translate>
            </div>
          )
        )}
      </div>
