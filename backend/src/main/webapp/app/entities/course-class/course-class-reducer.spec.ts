...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSECLASS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSECLASS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSECLASS actions', async () => {
      const arg = { id: 9434 };
    ...
    it('dispatches UPDATE_COURSECLASS actions', async () => {
      const arg = { id: 9434 };
    ...
    it('dispatches PARTIAL_UPDATE_COURSECLASS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURSECLASS actions', async () => {
      const arg = 42666;
