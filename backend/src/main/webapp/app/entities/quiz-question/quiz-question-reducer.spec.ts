...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUIZQUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUIZQUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUIZQUESTION actions', async () => {
      const arg = { id: 9500 };
    ...
    it('dispatches UPDATE_QUIZQUESTION actions', async () => {
      const arg = { id: 9500 };
    ...
    it('dispatches PARTIAL_UPDATE_QUIZQUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUIZQUESTION actions', async () => {
      const arg = 42666;
