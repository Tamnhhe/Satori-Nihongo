  ...
  return (
    <div>
      <h2 id="lesson-heading" data-cy="LessonHeading">
        <Translate contentKey="onlineSatoriPlatformApp.lesson.home.title">Lessons</Translate>
        ...
        {lessonList && lessonList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="onlineSatoriPlatformApp.lesson.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('slideUrl')}>
                  <Translate contentKey="onlineSatoriPlatformApp.lesson.slideUrl">Slide Url</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('slideUrl')} />
                </th>
                <th>
                  <Translate contentKey="onlineSatoriPlatformApp.lesson.course">Course</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="onlineSatoriPlatformApp.lesson.home.notFound">No Lessons found</Translate>
            </div>
          )
        )}
      </div>
