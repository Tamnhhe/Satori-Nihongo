...
export const LessonDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineSatoriPlatformApp.lesson.delete.question">
        <Translate contentKey="onlineSatoriPlatformApp.lesson.delete.question" interpolate={{ id: lessonEntity.id }}>
