...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTQUIZ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTQUIZ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTQUIZ actions', async () => {
      const arg = { id: 6648 };
    ...
    it('dispatches UPDATE_STUDENTQUIZ actions', async () => {
      const arg = { id: 6648 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTQUIZ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTQUIZ actions', async () => {
      const arg = 42666;
