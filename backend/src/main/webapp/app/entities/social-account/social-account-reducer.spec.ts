...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOCIALACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOCIALACCOUNT actions', async () => {
      const arg = { id: 23819 };
    ...
    it('dispatches UPDATE_SOCIALACCOUNT actions', async () => {
      const arg = { id: 23819 };
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOCIALACCOUNT actions', async () => {
      const arg = 42666;
