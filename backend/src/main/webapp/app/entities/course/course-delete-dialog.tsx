...
export const CourseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineSatoriPlatformApp.course.delete.question">
        <Translate contentKey="onlineSatoriPlatformApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
