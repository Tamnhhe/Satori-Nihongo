...
export const ScheduleDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/schedule${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineSatoriPlatformApp.schedule.delete.question">
        <Translate contentKey="onlineSatoriPlatformApp.schedule.delete.question" interpolate={{ id: scheduleEntity.id }}>
