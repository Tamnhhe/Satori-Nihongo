...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTPROFILE actions', async () => {
      const arg = { id: 14453 };
    ...
    it('dispatches UPDATE_STUDENTPROFILE actions', async () => {
      const arg = { id: 14453 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTPROFILE actions', async () => {
      const arg = 42666;
