  ...
  return (
    <div>
      <h2 id="student-profile-heading" data-cy="StudentProfileHeading">
        <Translate contentKey="onlineSatoriPlatformApp.studentProfile.home.title">Student Profiles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="onlineSatoriPlatformApp.studentProfile.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/student-profile/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="onlineSatoriPlatformApp.studentProfile.home.createLabel">Create new Student Profile</Translate>
          </Link>
        </div>
      </h2>
        ...
        {studentProfileList && studentProfileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="onlineSatoriPlatformApp.studentProfile.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('gpa')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('gpa')} />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/student-profile/${studentProfile.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/student-profile/${studentProfile.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="onlineSatoriPlatformApp.studentProfile.home.notFound">No Student Profiles found</Translate>
            </div>
          )
        )}
      </div>
