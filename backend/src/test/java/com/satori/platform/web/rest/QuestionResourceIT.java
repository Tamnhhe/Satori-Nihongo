...
class QuestionResourceIT {
    ...
    private static final String DEFAULT_ANSWER_EXPLANATION = "AAAAAAAAAA";
    private static final String UPDATED_ANSWER_EXPLANATION = "BBBBBBBBBB";
    ...
    public static Question createEntity() {
        return new Question()
            ...
            .answerExplanation(DEFAULT_ANSWER_EXPLANATION)
    ...
    void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.[*].answerExplanation").value(hasItem(DEFAULT_ANSWER_EXPLANATION)))
    ...
    void getQuestion() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.answerExplanation").value(DEFAULT_ANSWER_EXPLANATION))
