        ...
        {account && account.login ? (
          <View style={[styles.authContainer, styles.authContainerTrue]} testID="authDisplayTrue">
            <Text style={styles.authText}>
              <Ionicons name="checkmark-circle" size={22} color={'white'} style={{ position: 'absolute', marginLeft: -20 }} /> You are
          ...
          <View style={[styles.authContainer, styles.authContainerFalse]} testID="authDisplayFalse">
            <Text style={styles.authText}>
              <Ionicons name="information-circle" size={22} color={'white'} style={{ position: 'absolute', marginLeft: -20 }} /> You are not
              signed in.
            </Text>
          </View>
        )}
