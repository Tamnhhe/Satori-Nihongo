...
const create = (baseURL = AppConfig.apiUrl) => {
  ...
  const updateSocialAccount = socialAccount => api.put(`api/social-accounts/${socialAccount.id}`, socialAccount);
  const deleteSocialAccount = socialAccountId => api.delete('api/social-accounts/' + socialAccountId);

  const getTeacherProfile = teacherProfileId => api.get('api/teacher-profiles/' + teacherProfileId);
  ...
  const updateTeacherProfile = teacherProfile => api.put(`api/teacher-profiles/${teacherProfile.id}`, teacherProfile);
  const deleteTeacherProfile = teacherProfileId => api.delete('api/teacher-profiles/' + teacherProfileId);

  const getStudentProfile = studentProfileId => api.get('api/student-profiles/' + studentProfileId);
  ...
  const updateStudentProfile = studentProfile => api.put(`api/student-profiles/${studentProfile.id}`, studentProfile);
  const deleteStudentProfile = studentProfileId => api.delete('api/student-profiles/' + studentProfileId);
  ...
  const updateCourseClass = courseClass => api.put(`api/course-classes/${courseClass.id}`, courseClass);
  ...
  const updateQuizQuestion = quizQuestion => api.put(`api/quiz-questions/${quizQuestion.id}`, quizQuestion);
  ...
  const updateStudentQuiz = studentQuiz => api.put(`api/student-quizs/${studentQuiz.id}`, studentQuiz);
